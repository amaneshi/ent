	...
	for i := range columns {
		...
		case user.FieldDropOptional:
			if value, ok := values[i].(*sql.Null[string]); !ok {
				...
				_m.DropOptional = string(value.V)
			}
